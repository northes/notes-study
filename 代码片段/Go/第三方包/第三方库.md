...
4. [GitHub - dgraph-io/ristretto: A high performance memory-bound Go cache](https://github.com/dgraph-io/ristretto)
5. [GitHub - golang/groupcache: groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases.](https://github.com/golang/groupcache)
	- 分布式的缓存实现
6. [GitHub - goburrow/cache: Mango Cache 🥭 - Partial implementation of Guava Cache in Go (golang).](https://github.com/goburrow/cache)