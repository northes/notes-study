...
8. [GitHub - RediSearch/RediSearch: A query and indexing engine for Redis, providing secondary indexing, full-text search, vector similarity search and aggregations.](https://github.com/RediSearch/RediSearch)
9. Lucene [Apache Lucene - Welcome to Apache Lucene](https://lucene.apache.org/)
10. Solr [Welcome to Apache Solr - Apache Solr](https://solr.apache.org/)
11. RedisSearch [GitHub - RediSearch/RediSearch: A query and indexing engine for Redis, providing secondary indexing, full-text search, vector similarity search and aggregations.](https://github.com/RediSearch/RediSearch)
12. Sphinx [GitHub - sphinxsearch/sphinx: Sphinx search server](https://github.com/sphinxsearch/sphinx/)
13. manticoresearch [GitHub - manticoresoftware/manticoresearch: Easy to use open source fast database for search | Good alternative to Elasticsearch now | Drop-in replacement for E in the ELK soon](https://github.com/manticoresoftware/manticoresearch/)
14. Bluge [GitHub - blugelabs/bluge: indexing library for Go](https://github.com/blugelabs/bluge)
